...
public class ESFacetsHandlerTest {
    ...
    public void testParse() {
        ...
        assertThat(ESFacetsHandler.ESInterval.parse("YEAR").number).isEqualTo(1);

        assertThat(ESFacetsHandler.ESInterval.parse("1YEAR").unit).isEqualTo(DateRangeInterval.Unit.YEAR);
        assertThat(ESFacetsHandler.ESInterval.parse("2YEAR").unit).isEqualTo(DateRangeInterval.Unit.YEAR);
        assertThat(ESFacetsHandler.ESInterval.parse("2YEAR").number).isEqualTo(2);

        assertThat(ESFacetsHandler.ESInterval.parse("2 MINUTE").number).isEqualTo(2);

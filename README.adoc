...
The script can also be run against the elasticsearch implementation at amazon. This installation required username/password:

[source,bash]
----
(cd push-es-mappings/ ; mvn -Dhost=localhost:9200 -Duser=elastsicsearch -Dpassword=<>)
----

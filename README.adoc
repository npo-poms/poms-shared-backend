...
We recommend link:https://chromewebstore.google.com/detail/cpmmilfkofbeimbmgiclohpodggeheim[ElasticSearch Head] chrome plugin to connect to ES
...
you can test your changes by executing the UnitTest in `ESMediaRepositoryPart1ContainerTest`

...
public class CorsHeaders {
    ...
    public static final String ACCESS_CONTROL_ALLOW_HEADERS_VALUE = "authorization, x-http-method-override, origin, content-type, accept, x-npo-date, x-npo-mid, x-npo-url";
}
